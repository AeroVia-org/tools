...
import ObliqueShockVisualization from "./Visualization";
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <Navigation
        ...
        description="Calculate downstream properties across an oblique shock wave given upstream Mach number, shock angle, or deflection angle."
      />
                ...
                {gasType === "custom" && (
                  <div className="sm:col-span-1">
                    ...
                    <input
                      ...
                      step="0.001"
                      placeholder="γ"
                      className="block w-full rounded-md border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 focus:outline-none sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
