...
const OrbitalVisualization = ({
  ...
  useEffect(() => {
    ...
    earthGradient.addColorStop(0, "#4A90E2"); // Lighter blue center
    earthGradient.addColorStop(1, "#0E4A80"); // Darker blue edge
  ...
  return (
    <div ref={containerRef} className="relative w-full">
      <h3 className="mb-2 text-center text-lg font-semibold text-gray-800 dark:text-gray-100">Orbit Visualization</h3>
      <canvas
        ref={canvasRef}
        width={dimensions.width}
        height={dimensions.height}
        className="mx-auto block rounded-lg border border-gray-300 bg-gray-900 dark:border-gray-600" // Dark background for space feel
