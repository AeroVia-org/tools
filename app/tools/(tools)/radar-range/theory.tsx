export default function RadarRangeTheory() {
  ...
  return (
    <div className="border-border bg-card mt-8 rounded-lg border p-4 shadow-lg sm:p-6">
      <h3 className="text-foreground mb-3 text-lg font-semibold">Radar Range Equation Theory</h3>
      <div className="text-muted-foreground space-y-4 text-sm">
        ...
        <h4 className="text-foreground text-md pt-2 font-semibold">Key Assumptions and Notes:</h4>
        <ul className="list-disc space-y-1 pl-5">
